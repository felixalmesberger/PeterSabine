...
/**
 * Geaendert von Felix Almesberger
   Falls HomeSeite, alle in den Einstellung angegebenen Bilder anzeigen
   ansonsten, die über spacious_site_header ... angegeben sind
 */
function spacious_featured_image_slider($custom_image, $custom_text, $custom_title, $is_home) {
	global $post;
	?>
		...
		<section id="featured-slider">
			<div class="slider-cycle">
				<?php
				//Aenderung for schleife deaktiviert -> Original for( $i = 1; $i <= 1; $i++ ) {
				for( $i = 1; $i <= 1; $i++ ) {
					//Original
					//Changed by Felix Almesberger
					if($is_home)
					{
						...
						$spacious_slider_title = $custom_title;
						$spacious_slider_text = $custom_text;
						$spacious_slider_image = $custom_image;
					}
					//End Change
