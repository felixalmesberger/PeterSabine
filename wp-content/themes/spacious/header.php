...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header clearfix">
		...
		<?php spacious_featured_image_slider(get_post_meta(get_the_ID(), 'spacious_site_header_pic', true),get_post_meta(get_the_ID(), 'spacious_site_header_text', true),get_post_meta(get_the_ID(), 'spacious_site_header_title', true)); ?>
					...
					<div id="header-left-section">
						...
						?>
							...
							<div id="header-logo-image">
								...
								<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo of_get_option( 'spacious_header_logo_image', '' ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" width="247"></a>
